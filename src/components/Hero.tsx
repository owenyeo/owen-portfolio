  ...
  return (
    <div className="pb-20 pt-36">
        <div>
            ...
            <Spotlight className="top-10 left-full h-[80vh] w-[50vw]" fill="#00ffff" />
            <Spotlight className="top-28 left-80 h-[80vh] w-[50vw]" fill="#00ffff" />
        </div>
        ...
        <div className="flex justify-center relative my-20 z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                ...
                <p className="text-center md:tracking-wider mb-6 text-sm md:text-lg lg:text-2xl">
                    Hi! I&apos;m Owen, a Y4 Computer Science student at NUS College excited to make positive impacts
                    through AI. 
                </p>
                <a href="#about">
                    <MagicButton 
